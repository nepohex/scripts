 ...
 * Time: 0:35
 */
#todo 18/09/17 -> сделать функционал на 1 домен много языков
#todo 18/09/17 --> импорт много языков
#todo ------------> генерация вложенных меню. Плагин Page Menu.
...
$site_name = 'long40000site.com'; // Без слешей, только домен
$keyword = "long";
$blogname = ucwords("Long hairstyles gallery 2017");
$blogdescription = $blogname . ". Watch our super selection of Best Long Hairstyles for any man and woman 2017-2018.";
 ...
 * */
$google_images_mode = TRUE; // 1 / TRUE. Режим гугл картинок.
...
$int_mode = FALSE; //Режим других языков! Переключатель, если FALSE то Language_id не работает.
