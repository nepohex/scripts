...
$site_name = 'eventshairstyles.xyz'; // Без слешей, только домен
$keyword = "event";
$blogname = ucwords("Fashionable hairstyles for special event");
$blogdescription = $blogname . ". Choose your own stylish hairstyle.";
...
$installer['cache_dir'] = $installer['site_path'] . $site_name . '/public_html/cache/';
...
//$global_host_sites_path = '/home/wtfowned/web/';
////Это путь к плагину который идет в wp-config
//$wpcachehome = $global_host_sites_path . $site_name . '/public_html/wp-content/plugins/wp-super-cache/';
////Это путь куда будет складываться кеш
//$wp_cache_dir = $global_host_sites_path . $site_name . '/public_html/cache/';
//$installer_db_host = 'localhost';
//$installer_db_usr = 'root';
//$installer_db_pwd = 'RABCkgt0rKhF';
////Команда интсаллера которую запишем в логи для удобства. Следить за именем юзера хостинга!
//$installer_command = 'cd ' . $global_host_sites_path . $site_name . '/public_html/;unzip -o -q site.zip;php installer.php;rm -f installer.php site.zip;chown -R  wtfowned ' . $global_host_sites_path . $site_name . ';';
