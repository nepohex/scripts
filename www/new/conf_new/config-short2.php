...
$site_name = 'short2site.com'; // Без слешей, только домен
$keyword = "short";
$blogname = ucwords("Short hairstyles gallery 2017");
$blogdescription = $blogname.". Largest Short Hairstyles Gallery with over 20000 perfect looks.";
