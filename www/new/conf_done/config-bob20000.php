...
$site_name = 'bob20000site.com'; // Без слешей, только домен
$keyword = "bob";
$blogname = ucwords("Bob hairstyles gallery 2017");
$blogdescription = $blogname.". Get inspired with these ideas on how to experiment with bob hairstyle. Another day, another bob.";
