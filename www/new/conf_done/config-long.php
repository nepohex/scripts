...
$site_name = 'orseproyalhotel.com'; // Без слешей, только домен
$keyword = "long";
$blogname = ucwords("Long hairstyles 2017");
$blogdescription = $blogname.". Find The Latest Long Hairstyles ideas 2017 in biggest gallery.";
