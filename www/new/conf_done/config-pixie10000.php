...
$site_name = 'pixie10000site.com'; // Без слешей, только домен
$keyword = "pixie";
$blogname = ucwords("Pixie hairstyle ideas 2017");
$blogdescription = $blogname . ". Check out the best Pixie Hairstyles 2017 to help you achieve stunning effects.";
...
$images_per_site = 10000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
