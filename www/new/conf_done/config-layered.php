...
$site_name = 'lanmienresort.com'; // Без слешей, только домен
$keyword = "layered";
$blogname = ucwords("Hottest layered hairstyles 2017");
$blogdescription = $blogname.". Layered hairstyles are the best - they make you look younger and attractive.";

//HOSTING DATA для инсталлера и корректных конфигов Wp super cache
$installer['site_owner'] = 'wtfowned'; //Логин пользователя владельца файлов сайта на хосте.
$installer['db_prefix'] = 'wtfowned_';
$installer['site_path'] = '/home/wtfowned/web/';
//Это путь к плагину который идет в wp-config.php
$installer['wpcachepluginpath'] = $installer['site_path'] . $site_name . '/public_html/wp-content/plugins/wp-super-cache/';
//Это путь куда будет складываться кеш > важно чтобы было синхронно с HTACCESS, идет в wp-content/wp-cache-config.php
$installer['cache_dir'] = $installer['site_path'] . $site_name . '/public_html/wp-content/cache/';
...
$images_per_site = 15000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
...
$cats = 35; // Сколько категорий автоматом создать
...
$publish = 70; // % постов от текущих PUBLISH сколько отправляем в PENDING
...
$autocat_strict_word_exclude = array('a', 'you', 'it', 'cut', 'to', 'in', 'the', 'on', 'what', 'of', 'for', 'at', 'by', 'is', 'in', 'and', 'do', 'how', 'this', 'that', 'can', 'part', 'new', 'with', 'in', 'can', 'be', 'or', 'as', 'its', 'as', 'an', 'its', 'will', 'by', 'into', 'get','cuts','over'); //Строгое исключение данных слов в качестве категории
