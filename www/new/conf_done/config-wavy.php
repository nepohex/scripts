...
$site_name = 'wavysite.com'; // Без слешей, только домен
$keyword = "wavy";
$blogname = ucwords("Wavy hairstyles 2017");
$blogdescription = $blogname.". Find your best hairstyle for Wavy / Curly hair from largest gallery.";
