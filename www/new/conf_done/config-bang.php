...
$site_name = 'codyfineartgallery.com'; // Без слешей, только домен
$keyword = "bang";
$blogname = ucwords("Best hairstyles with bangs 2017");
$blogdescription = $blogname.". The trendiest haircuts and styles you need to wear in 2017.";
