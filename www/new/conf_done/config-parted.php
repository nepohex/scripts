...
$site_name = 'sidepartedhairstyles.men'; // Без слешей, только домен
$keyword = "parted";
$blogname = ucwords("Side parted hairstyle ideas 2017");
$blogdescription = ucwords($blogname.". side parted mens hairstyles which really pulls a man look distinguished!");
