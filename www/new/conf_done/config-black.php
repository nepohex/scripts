...
$site_name = 'sydneyoperahotels.com'; // Без слешей, только домен
$keyword = "black";
$blogname = ucwords("8000 black hairstyles ideas 2017");
$blogdescription = $blogname.". Largest and most up to date black hairstyles gallery in 2017.";
