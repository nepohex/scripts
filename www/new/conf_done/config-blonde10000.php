...
$site_name = 'blond10000site.com'; // Без слешей, только домен
$keyword = "blond";
$blogname = ucwords("Blonde hairstyles gallery 2017");
$blogdescription = $blogname . ". From dazzling golds to sparkling champagnes, see the most outstanding blonde hair color shades 2017 in our gallery.";
