...
$site_name = 'braidsite.com'; // Без слешей, только домен
$keyword = "braid";
$blogname = ucwords("Braid hairstyles gallery 2017");
$blogdescription = $blogname.". Largest Braids hairstyles gallery with over 20000 perfect looks.";
