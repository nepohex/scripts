...
$site_name = 'bashfulfashionista.com'; // Без слешей, только домен
$keyword = "retro";
$blogname = ucwords("Retro hairstyles 2017");
$blogdescription = $blogname.". Retro Hairstyles ideas 2017 for every man and woman.";
