...
$site_name = 'updosite.com'; // Без слешей, только домен
$keyword = "updo";
$blogname = ucwords("Updo hairstyles 2017");
$blogdescription = $blogname.". Choose your best updo hairstyle from biggest gallery.";
