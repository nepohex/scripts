...
$site_name = 'heli-rnd.com'; // Без слешей, только домен
$keyword = "curly";
$blogname = ucwords("8000 curly hairstyles ideas 2017");
$blogdescription = $blogname.". With curly hair, styles always look way more complicated than they really are.";
