...
$site_name = 'updo10000site.com'; // Без слешей, только домен
$keyword = "updo";
$blogname = ucwords("Updo hairstyles gallery 2017");
$blogdescription = $blogname . ". Get inspiration from one of 10000 beautiful updos for your next event or a chic new way to wear your hair to the party.";
