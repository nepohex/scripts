...
$site_name = 'dreadlocks2017.xyz'; // Без слешей, только домен
$keyword = "dread";
$blogname = ucwords("Amazing dreadlocks hairstyles 2017");
$blogdescription = $blogname.". The Hottest Dreadlocks Styles to Try In 2017.";
