...
$site_name = 'pixiesite.com'; // Без слешей, только домен
$keyword = "pixie";
$blogname = ucwords("Pixie hairstyles 2017");
$blogdescription = $blogname.". Pixie hairstyles always chic and makes you look younger.";
...
$images_per_site = 12000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
