...
$site_name = 'bang25000site.com'; // Без слешей, только домен
$keyword = "bang";
$blogname = ucwords("Hairstyles with bangs 2017");
$blogdescription = $blogname . ". Choose best hairstyle with bang which suits you perfectly from over 25000 ideas.";
...
$images_per_site = 25000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
...
$cats = 60; // Сколько категорий автоматом создать
...
$publish = 80; // % постов от текущих PUBLISH сколько отправляем в PENDING
$multicat = true; // Каждому посту будет присвоено больше 1ой категории. Больше упор на ВЧ запросы получается из за бредкрампов.
$max_posts_per_cat = 20; //20 означает максимум 5% постов в 1 категорию. Если активна Multicat, то лучше разрешить все посты в 1 категорию. По факту, лучше не становится другим категориям от уменьшения больших.
