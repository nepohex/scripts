...
$site_name = 'shorthairstyle.club'; // Без слешей, только домен
$keyword = "short";
$blogname = ucwords("Short hairstyles 2017");
$blogdescription = $blogname.". Latest Short Hairstyles photos 2017 for every man and woman.";
...
$images_per_site = 5000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
