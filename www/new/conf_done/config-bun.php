...
$site_name = 'bun-hairstyles.com'; // Без слешей, только домен
$keyword = "bun";
$blogname = ucwords("Bun hairstyles for men and women 2017");
$blogdescription = $blogname.". The Best Bun Hairstyles for Every Occasion.";
