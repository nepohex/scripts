...
$site_name = 'naturalsite.com'; // Без слешей, только домен
$keyword = "natural";
$blogname = ucwords("Natural hairstyles ideas 2017");
$blogdescription = $blogname.". Biggest gallery with natural hair ideas.";
