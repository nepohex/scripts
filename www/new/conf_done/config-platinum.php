...
$site_name = 'platinumhair.info'; // Без слешей, только домен
$keyword = "platinum";
$blogname = ucwords("Platinum blonde hairstyles for men and women 2017");
$blogdescription = $blogname.". Ideas for long, short and medium hair.";
