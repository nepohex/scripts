...
$site_name = 'netvoine.info'; // Без слешей, только домен
$keyword = "wedding";
$blogname = ucwords("Wedding hairstyles 2017");
$blogdescription = $blogname.". Choose your best special day hairstyle from biggest gallery.";
