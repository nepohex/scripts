...
$site_name = 'brownsite.com'; // Без слешей, только домен
$keyword = "brown";
$blogname = ucwords("Brown hair hairstyles 2017");
$blogdescription = $blogname.". Find your best brown color hairstyle.";
