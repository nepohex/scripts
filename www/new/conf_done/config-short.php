...
$site_name = 'terrafloradenver.com'; // Без слешей, только домен
$keyword = "short";
$blogname = ucwords("Short hairstyles 2017");
$blogdescription = $blogname.". Find The Latest Hottest Short Hairstyles from over 25000 ideas 2017.";
