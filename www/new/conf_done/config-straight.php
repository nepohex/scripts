...
$site_name = 'straightsite.com'; // Без слешей, только домен
$keyword = "straight";
$blogname = ucwords("straight hair ideas 2017");
$blogdescription = $blogname.". Biggest gallery of hairstyles for straight hair.";
