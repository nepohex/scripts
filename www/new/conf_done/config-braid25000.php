...
$site_name = 'braid25000site.com'; // Без слешей, только домен
$keyword = "braid";
$blogname = ucwords("Braided hairstyles gallery 2017");
$blogdescription = $blogname . ". Find the braided hairstyle for your hair and face shape from over 25000 inspiring photos.";
