...
$site_name = 'cat-portal.org'; // Без слешей, только домен
$keyword = "bob";
$blogname = ucwords("Bob hairstyles 2017");
$blogdescription = $blogname.". Bob and lob hairstyle photos for inspiration for your new haircut. Any type and style!";
...
$images_per_site = 8000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
...
$cats = 30; // Сколько категорий автоматом создать
