...
$site_name = 'medium30000site.com'; // Без слешей, только домен
$keyword = "medium";
$blogname = ucwords("Medium hairstyles gallery 2017");
$blogdescription = $blogname.". Stunning inspirational pictures of mid-length hairstyles. The shoulder length hairstyles will be your ideal option";
