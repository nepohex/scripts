...
$site_name = 'momdresses.net'; // Без слешей, только домен
$keyword = "spring";
$blogname = ucwords("Best spring hairstyles 2017");
$blogdescription = $blogname.". The trendiest haircuts and styles you need to wear this spring.";
...
$images_per_site = 3000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
