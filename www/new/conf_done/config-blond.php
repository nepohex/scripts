...
$site_name = 'photos-de-lingerie.com'; // Без слешей, только домен
$keyword = "blond";
$blogname = ucwords("Blond hairstyles 2017");
$blogdescription = $blogname.". Latest Blond Hairstyles ideas 2017 in biggest gallery.";
