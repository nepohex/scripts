...
$site_name = 'men30000site.com'; // Без слешей, только домен
$keyword = "men";
$blogname = ucwords("Mens hairstyles gallery 2017");
$blogdescription = $blogname.". Get inspired by the BEST mens hairstyles and men's haircuts for 2017 that created by the best barbers in the world.";
...
$synonyms[] = array('curly','wavy','weave','weaves');
