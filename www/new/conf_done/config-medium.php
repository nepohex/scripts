...
$site_name = 'dcexecutivespace.com'; // Без слешей, только домен
$keyword = "medium";
$blogname = ucwords("Medium hairstyles 2017");
$blogdescription = $blogname.". Latest Medium Hairstyles 2017 - over 25000 ideas.";
...
$installer['site_path'] = '/home/mounter/web/';
...
$images_per_site = 30000; // Сколько картинок брать на 1 сайт (без учета их размера, еще может сильно сократиться, обычно на 20% в итоге выходит)
...
$cats = 45; // Сколько категорий автоматом создать
