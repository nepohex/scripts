...
if ($int_mode) {
    $backup_name = $lang_id . 'dump.sql';
    Export_Database($db_host, $db_usr, $db_pwd, $db_name, $tables = false, $backup_name, $work_dir . '/');
} else {
    Export_Database($db_host, $db_usr, $db_pwd, $db_name, $tables = false, $dump, $work_dir . '/');
}
