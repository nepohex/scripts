...
#todo Поправить базу, убрать my_spintax таблицу.
...
#todo чтобы не захламлять папку рабочую вынести файлы с выгрузками CSV в отдельную папку, если напрямую путь поменять то там за собой тянет еще кучу всего
